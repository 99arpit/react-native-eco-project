    ...
    return (
        <>
            ...
            <View style={styles.container}>
                {/* <Text style={[styles.red, styles.bigBlue,]}>Sign up</Text> */}
                ...
                <View style={styles.ar}>
                    <SafeAreaView >
                        ...
                        />
                        <Text style={{ paddingLeft: 25, color: 'black' }}>Password is too short</Text>
                        <View style={{ flexDirection: 'row' }}>

                            <Text style={{ color: 'red', textDecorationLine: 'underline', paddingLeft: 230, fontSize: 16 }}>User already exists</Text>
